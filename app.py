...
st.markdown("This is an example simulation of a 2D missile engagment. The engagement is configurable with initial conditions and a choice of navigation gains for the proportional navigation guidance law used by the missile.")
...
TargetDf, MissileDf, score, missDist = runSimulation(initialTgtX, initialTgtY, initialMslX, initialMslY, navGain)
